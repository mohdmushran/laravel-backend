						...
						<div class="row">
							...
							<div class="col-6 col-12-medium">
								...
								<!-- Image -->
									<h3>Image</h3>
									<h4>Fit</h4>
									<span class="image fit"><img src="{{ asset('images/pic01.png') }}" alt="" /></span>
									<div class="box alt">
										<div class="row gtr-50 gtr-uniform">
											<div class="col-4"><span class="image fit"><img src="{{ asset('images/pic01.png') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('images/pic01.png') }}" alt="" /></span></div>
											<div class="col-4"><span class="image fit"><img src="{{ asset('images/pic01.png') }}" alt="" /></span></div>
											<!-- Break -->
											<div class="col-4"><span class="image fit"><img src="{{ asset('images/pic01.png') }}" alt="" /></span></div>
									...
									<h4>Left &amp; Right</h4>
									<p>
										<span class="image left"><img src="{{ asset('images/pic02.png') }}" alt="" /></span>
									...
									<p>
										<span class="image right"><img src="{{ asset('images/pic02.png') }}" alt="" /></span>
										Lorem ipsum dolor sit accumsan interdum nisi, quis tincidunt felis sagittis eget.
										tempus euismod. Magna et cursus lorem faucibus vestibulum. Blandit adipiscing eu
										felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque
										praesent tincidunt felis sagittis eget. tempus euismod tempus. Vestibulum ante ipsum
